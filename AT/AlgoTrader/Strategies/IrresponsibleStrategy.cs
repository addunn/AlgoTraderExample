...
{
    [Serializable]
    public class IrresponsibleStrategy : Strategy
    {

        public IrresponsibleStrategy(string symbol, decimal probability, string id): base(symbol, probability, id)
        {
            Description = "It's buys and sells very frequently.";
        }
        ...
        public override StrategyOrderActions ComputeActions()
        {
            ...
            if (openPosition != null)
            {
                ...
                int n = AT.UC.GetRandomInteger(1, 3);
                ...
                if(n == 1)
                {
                    ...
                    if (orderToCancel != null)
                    {
                        ...
                        cancelOA.Type = OrderActionType.Cancel;

...
{
    [Serializable]
    public class LongHoldStrategy : Strategy
    {

        public LongHoldStrategy(string symbol, decimal probability, string id) : base(symbol, probability, id)
        {
            Description = "Buys and holds until end of day.";
        }
        ...
        public override StrategyOrderActions ComputeActions()
        {
            ...
            if (openPosition != null)
            {
                ...
                if (AlgoTraderState.CurrentTime.IsOnOrPassed(15, 0))
                {
            ...
            else
            {
                ...
                if (AlgoTraderState.CurrentTime.IsBetween(10, 0, 11, 0))
                {
                    ...
                    stopLossOrder.StopPrice = currentPrice - 2.00M;
